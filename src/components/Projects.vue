    ...
    <div class="w-100">
      ...
      >
        <div class="resume-content">
          ...
          class="subheading mb-0 ml-3"
          style="cursor:pointer"
          >
              <font-awesome-icon :icon="['fa', project.info.show?'minus-square':'plus-square']"></font-awesome-icon>
            {{ project.function }} @ {{ project.entity }}
          </div>

          <div v-show="project.info.show">
            <div v-if="project.info.url">
              Lien vers le projet
              <a :href="project.info.url" target="_blank">ici</a>
            </div>
            <div class="ml-3 contrast-text">{{ project.info.description }}</div>
            <div v-if="project.info.tools" class="mb-1">
      ...
      projectList: [
        {
          ...
          info: {
            ...
            description:
            `Pour faire un CV axé sur les projets et compétences et améliorer mes compétence Front j'ai forké le projet
        ...
        },
        {
          ...
          info: {
            description:
            `Le service WSSE commence à développer ses nouveaux outils sous Unity.
        ...
        },
        {
          ...
          info: {
            description:
            `Pour utiliser des technologies de cartographie plus modernes et souples, une
...
scénarios.`,
        ...
        },
        {
          ...
          entity: "MBDA",
          info: {
            description: "Passage de plugin Fusion (C++) à des appels core API (C).",
            tools: [
              {
                name: "VBS3"
              },
        ...
        },
        {
          ...
          info: {
            description:
            `Pour partager une interface similaire entre les différentes simulations sur divers
...
protocoles de communications (UDP, HLA et RabbitMQ).`,
        ...
        },
        {
          ...
          entity: "MBDA",
          info: {
            description: "VBS3 ne supporte plus son framework C++ (plugin Fusion) et passe à un framework C.",
            tools: [
              {
                name: "C"
              },
        ...
        },
        {
          ...
          entity: "MBDA",
          info: {
            description: "Création d'un simulateur de système d'hélicoptère pour tester un module de tir tierce.",
            tools: [
              {
                name: "Java 8/11"
              },
...
et ajouter des fonctionnalités à un simulateur Air-Surface pour des essais.`,
        ...
        },
        {
          ...
          entity: "UQAC",
          info: {
            description: "Résolution du jeu de plateau ('Concept') par techniques de machine learning",
...
passer devant un comité green-light`,
        ...
        {
          title: " Développement et installation d'outils de gestion pour administrateurs SA",
          function: "[Stagiaire] Administration SAP et développement applicatif",
          entity: "Oxya - Loos",
          info: {
...
et platforme de syncronisation des différents outils de ticketing.`,
        ...
        },
        {
          ...
          function: "[Étudiant] Développeur Full-Stack, microgiciel et électronicien",
...
manière de IFTTT) pour http://www.myconstellation.io/.`,
        ...
        {
          title: "Développements, déploiement et tests d'applications et solutions divers.",
